...
//   const handleEdit = () => {
//     dispatch(editColumn({ id: _id, title: newTitle }));
//     setIsModalOpen(false);
//   };
...
//       <div className={css.column}>
//         <h2 className={css.column_title}>{title}</h2>
//         <button className={css.editColumn} onClick={() => setIsModalOpen(true)}>
//           <svg className={css.logoIcon}>
//             <use href={sprite + "#icon-pencil-01"}></use>
//           </svg>
//         </button>
...
//       <div className={css.button_add_card}>
//         <button onClick={() => setIsAddCardModalOpen(true)}>Add another card</button>
//       </div>
  ...
  return (
    <div className={css.container_columns}>
      ...
      <Modal
        ...
        onRequestClose={() => setIsModalOpen(false)}
        contentLabel="Edit Column"
        className={css.modalContent} // Класс для стилизации контента модального окна
        overlayClassName={css.modalOverlay} // Класс для стилизации оверлея модального окна
      >
        <h2>Edit Column</h2>
        <form
          onSubmit={(e) => {
